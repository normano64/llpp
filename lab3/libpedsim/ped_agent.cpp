...
Ped::Tvector Ped::Tagent::whereToGo() {
    ...
    if (lastDestination == NULL) {
        ...
        waypointForce = tempDestination.getForce(position.x, position.y, 0, 0, &reachesDestination);
    } else {
        waypointForce = destination->getForce(position.x, position.y,
