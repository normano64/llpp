...
do
    ...
    if [ "$i" == 1 ]; then
        ...
        do
            printf .
            LD_LIBRARY_PATH=. ./demo --silent --timing-mode --plot --threads "$i"
        done
        ...
        do
            printf .
            LD_LIBRARY_PATH=. ./demo --silent --timing-mode --plot --threads "$i" --simd
        done
        ...
        do
            printf .
            LD_LIBRARY_PATH=. ./demo --silent --timing-mode --opencl --plot
        done
    ...
    do
        printf .
        LD_LIBRARY_PATH=. ./demo --silent --timing-mode --pthreads --plot --threads "$i"
    done
    ...
    do
        printf .
        LD_LIBRARY_PATH=. ./demo --silent --timing-mode --pthreads --plot --threads "$i" --simd
    done
    ...
    do
        printf .
        LD_LIBRARY_PATH=. ./demo --silent --timing-mode --omp --plot --threads "$i" --simd
    done
